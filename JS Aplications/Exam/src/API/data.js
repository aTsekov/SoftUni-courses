...
const endpoint = {
    ...
    "logout": "users/logout",
    "getAllItems": "data/albums?sortBy=_createdOn%20desc", // CHECK ALL URLS AS THE SLASH/ SHOULD BE HERE AND NOT ON THE HOST.
    "getElementById":"data/albums/",
    "deleteItemById": "/data/albums/",
    "createItem": "data/albums/",
    "updateItemById" :"data/albums/"    
