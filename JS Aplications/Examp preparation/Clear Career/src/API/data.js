...
const endpoint = {
    ...
    "logout": "users/logout",
    "getAllItems": "data/offers?sortBy=_createdOn%20desc", // CHECK ALL URLS AS THE SLASH/ SHOULD BE HERE AND NOT ON THE HOST.
    "getElementById":"data/offers/",
    "deleteItemById": "data/offers/",
    "createItem": "data/offers",
    "updateItemById" :"data/offers/"    
