...
function solve() {
  ...
  function publish(e) {
    ...
    if (make.value !== undefined && model.value !== undefined && Number(originalCost.value) !== undefined
      ...
      //It is very important where exactly the event listener is placed/ 
      //Additionally by adding the event listener to the button basically I will add it to all buttons of the same type that will be created at some point. 
...
// Calculate the profit at the bottom fo the page.
